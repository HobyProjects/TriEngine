...
#============================================================================================================================================
    ...
    EXTERNAL_LIBRARIES = [
        PreCompileLibraries("glfw", "Vendors/glfw", "Vendors/build/config/glfw", "Vendors/build/packages/glfw", ""),
        PreCompileLibraries("spdlog", "Vendors/spdlog", "Vendors/build/config/spdlog", "Vendors/build/packages/spdlog", ""),
        PreCompileLibraries("glad", "Vendors/glad", "Vendors/build/config/glad", "Vendors/build/packages/glad", ""),
